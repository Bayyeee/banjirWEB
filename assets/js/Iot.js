function getData(location) {
    return fetch("https://data.bmkg.go.id/DataMKG/MEWS/DigitalForecast/DigitalForecast-KalimantanSelatan.xml") // Fetch API Data BMKG
...
function startTime() {
    ...
    let dateString = today.toLocaleString('id-ID', optionsDate);  // Menggunakan bahasa Indonesia
    let timeString = today.toLocaleString('id-ID', optionsTime);  // Menggunakan bahasa Indonesia
